	...
	return (
		<div className="dev_div">
			<h1 className="dev_title">dev</h1>
				<div className='dev_filter'><h2 className='dev_filter_option'    id='html'>html - css</h2>
			<h2 className='dev_filter_option' id='javascript'>java script</h2>
			<h2 className='dev_filter_option'   id='react'>react</h2>
			<h2 className='dev_filter_option' id='node'>node js - express</h2>
			</div>  
